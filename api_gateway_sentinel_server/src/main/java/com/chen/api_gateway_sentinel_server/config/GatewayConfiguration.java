package com.chen.api_gateway_sentinel_server.config;
...
//				)
//		);
/*		rules.add(new GatewayFlowRule("abc")//资源名称
				.setCount(1)// 限流阈值
				.setIntervalSec(1)// 统计时间窗口，单位是秒，默认是 1 秒
		);*/
		rules.add(new GatewayFlowRule("order_api")//资源名称
				.setCount(1)// 限流阈值
				.setIntervalSec(1)// 统计时间窗口，单位是秒，默认是 1 秒
		);
	...
	private void initCustomizedApis() {
		...
		ApiDefinition api1 = new ApiDefinition("order_api")
				.setPredicateItems(new HashSet<ApiPredicateItem>() {{
					add(new ApiPathPredicateItem().setPattern("/abc/order/**").
