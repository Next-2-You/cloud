package com.chen.order_service_sentinel_rest;

import com.alibaba.cloud.sentinel.annotation.SentinelRestTemplate;
import com.chen.order_service_sentinel_rest.exception.ExceptionUtils;
...
public class OrderServiceSentinelRestApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(OrderServiceSentinelRestApplication.class, args);
    }
